      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/collections/iphone" className="text-gray-600 hover:text-gray-900 transition-colors">iPhone Cases</Link></li>
              <li><Link to="/collections/samsung" className="text-gray-600 hover:text-gray-900 transition-colors">Samsung Cases</Link></li>
              <li><Link to="/collections/google" className="text-gray-600 hover:text-gray-900 transition-colors">Google Pixel Cases</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/returns" className="text-gray-600 hover:text-gray-900 transition-colors">Returns</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Subscribe to our newsletter for new products and deals.</p>
            <form className="flex">
              <input 
                type="email" 
                placeholder="Your email" 
                className="min-w-0 flex-1 px-4 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-black"
              />
              <button 
                type="submit" 
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-r-md text-white bg-black hover:bg-gray-900 focus:outline-none"
              >
                Sign Up
              </button>
            </form>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">&copy; 2025 CaseCraft. All rights reserved.</p>
